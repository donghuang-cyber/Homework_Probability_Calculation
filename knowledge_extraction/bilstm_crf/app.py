...
class MedicalNerModel(object):
    ...
    def __init__(self):
        ...
        self.word2id,_,self.id2tag = pickle.load(
                open("D:/LLM+KG/KBQA-for-Diagnosis-main/KBQA-for-Diagnosis-main/knowledge_extraction/bilstm_crf/checkpoint/word_tag_id.pkl","rb")
            )
        self.model = BiLstmCrfModel(80,2410,200,128,24).build()
        self.model.load_weights('D:/LLM+KG/KBQA-for-Diagnosis-main/KBQA-for-Diagnosis-main/knowledge_extraction/bilstm_crf/checkpoint/best_bilstm_crf_model.h5')

        self.nbd = NerBaseDict('D:/LLM+KG/KBQA-for-Diagnosis-main/KBQA-for-Diagnosis-main/knowledge_extraction/bilstm_crf/checkpoint/diseases.json')
...
if __name__ == '__main__':
    ...
    server = pywsgi.WSGIServer(("127.0.0.1",60061), app)
